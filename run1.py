...
def get_bot_response(user_message: str) -> str:
    """
    Generate a simple bot response based on keywords in the user message.
    """
    msg = user_message.lower()
    if any(greet in msg for greet in ["hi", "hello", "hey"]):
        return "Hello there! How can I assist you today?"
    elif "help" in msg:
        return "I can help you generate a personalized meal and exercise plan. Please fill out your details above."
    elif "plan" in msg:
        return "After you submit your details, I'll generate a plan for you!"
    else:
...
def update_chat(user_message: str):
    """
...
chat_input = st.sidebar.text_input("Type your message here:")
if st.sidebar.button("Send"):
    if chat_input:
        update_chat(chat_input)
        st.sidebar.text_input("Type your message here:", value="", key="dummy")  # Clear input
...
st.markdown("## Enter Your Details for a Personalized Plan")
