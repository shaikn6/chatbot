...
openai.api_key = os.getenv("OPENAI_API_KEY", "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")
...
def get_ai_response(user_message: str, context: list) -> str:
    """
    Generate a dynamic response using OpenAI's GPT model.
    """
    try:
...
def update_dynamic_chat(user_message: str):
    ...
    # Get AI response via OpenAI's API.
